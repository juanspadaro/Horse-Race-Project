...
variables_problematicas <- c("ratings_group", "jockey_id", "trainer_id")
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# ~~ 3.1) Random Forest (---------tipo_practica---------)#### 
...
y_pred <- predict(rf, test_set, type = "prob")[, 2]
...
logit_reg <- glm(won ~ ., data = train_set, family = binomial(link = "logit"))
summary(logit_reg)
